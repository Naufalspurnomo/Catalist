...
import { FiEye, FiChevronDown, FiChevronUp, FiSearch, FiChevronLeft, FiChevronRight } from 'react-icons/fi';
          ...
          <div>
            <p className="text-sm text-gray-700">
              ...
              <span className="font-medium">
                {Math.min((state.pageIndex + 1) * state.pageSize, orders.length)}
              </span>
              {' '}dari{' '}
              <span className="font-medium">{orders.length}</span> hasil
            </p>
          </div>
          <div>
